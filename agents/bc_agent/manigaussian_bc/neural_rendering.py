...
import agents.bc_agent.manigaussian_bc.utils as utils
from agents.bc_agent.manigaussian_bc.models_embed import GeneralizableGSEmbedNet
from agents.bc_agent.manigaussian_bc.loss import l1_loss, l2_loss, cosine_loss, ssim
from agents.bc_agent.manigaussian_bc.graphics_utils import getWorld2View2, getProjectionMatrix, focal2fov
from agents.bc_agent.manigaussian_bc.gaussian_renderer import render
...
class NeuralRenderer(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        if self.model_name == "diffusion":
            ...
            from agents.bc_agent.manigaussian_bc.dino_extractor import VitExtractor
            import torchvision.transforms as T
    ...
    def forward(self, pcd, dec_fts, language, gt_rgb=None, gt_pose=None, gt_intrinsic=None, rgb=None, depth=None, camera_intrinsics=None, camera_extrinsics=None, 
        ...
        if training:
            # Gaussian Generator（即models_embed文件中的gaussian渲染器模型）
