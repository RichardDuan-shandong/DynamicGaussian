...
class dyna_q_manigaussian_agent(object):
    ...
    def update(self, step: int, replay_sample: dict, fabric: Fabric) -> dict:
        ...
        if self.use_neural_rendering:  # eval default: False; train default: True
            ...
            # total_loss = 0.0001 * total_loss + lambda_nerf * rendering_loss_dict['loss']  # 不加action loss
            #  total_loss = lambda_BC * total_loss # 不加rendering loss
            # for print
            ...
            lambda_reg = (
                             self.cfg.neural_renderer.lambda_reg if step >= self.cfg.neural_renderer.next_mlp.warm_up else 0.) * lambda_nerf  # 0.01
