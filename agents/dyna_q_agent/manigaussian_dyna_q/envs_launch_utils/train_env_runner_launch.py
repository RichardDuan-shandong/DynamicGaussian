...
from agents.dyna_q_agent.manigaussian_dyna_q.envs_launch_utils.train_env_runner import _IndependentEnvRunner
...
class IndependentEnvRunner(EnvRunner):
    ...
    def start(self, weight,
        ...
        # 由于只进行训练，不需要传入eval_env
        self._internal_env_runner = _IndependentEnvRunner(
            self._train_env, None, self._agent, self._timesteps, self._train_envs,
