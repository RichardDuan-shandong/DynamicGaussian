...
from yarr.utils.video_utils import CircleCameraMotion, TaskRecorder, NeRFTaskRecorder   # NeRFTaskRecorder是用于nerf数据生成的，但是这里为什么不直接使用20个多视角的相机直接渲染呢？
        ...
        for ex_idx in range(FLAGS.episodes_per_task):
            ...
            while attempts > 0:
                try:
                    ...
                    # live_demos=True 代表获取到的演示数据都是通过实时演示获得的
