...
import random
from perception_.dataloader import _load_data
from perception_.train import train
...
def run_seed(i, lock, task_index, cfg, seed, fabric):
    ...
    data_origin = _load_data(cfg, fabric)
    
    train(data_origin, cfg, fabric)
