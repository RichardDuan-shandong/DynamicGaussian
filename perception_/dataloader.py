...
from perception_.const import MULTI_VIEW_DATA, SEG_FOLDER, EPISODE_FOLDER, EPISODES_FOLDER, VARIATIONS_ALL_FOLDER, POSE, IMAGES
...
class CustomDataset(Dataset):
    ...
    def __getitem__(self, idx):
        image_path, pose_path, task_description = self.data_list[idx]['image_path'], self.data_list[idx]['pose_path'], self.data_list[idx]['task']
        ...
        return {'image': image, 'pose': pose, 'description': task_description}


def _load_data(cfg, fabric):
    ...
    # dataloader = fabric.setup_dataloaders(dataloader)   # no fabric, or it will break the original order fo the data set
