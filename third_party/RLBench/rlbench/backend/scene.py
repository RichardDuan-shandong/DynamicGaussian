...
class Scene(object):
    ...
    def check_target_in_workspace(self, target_pos: np.ndarray) -> bool:
        x, y, z = target_pos
        # print(
        #    f'minx:{self._workspace_minx}, maxx:{self._workspace_maxx}, miny:{self._workspace_miny}, maxy:{self._workspace_maxy}, minz:{self._workspace_minz}, maxz:{self._workspace_maxz}')
