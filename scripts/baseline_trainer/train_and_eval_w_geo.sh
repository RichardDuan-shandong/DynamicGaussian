...
#       bash scripts/baseline_trainer/train_and_eval_w_geo.sh ManiGaussian_BC 0,1 12345 ${exp_name}
# Other examples:
#       bash scripts/baseline_trainer/train_and_eval_w_geo.sh GNFACTOR_BC 0,1 12345 ${exp_name}
#       bash scripts/baseline_trainer/train_and_eval_w_geo.sh PERACT_BC 0,1 12345 ${exp_name}
...
tmux send-keys "conda activate manigaussian; CUDA_VISIBLE_DEVICES=${train_gpu} python train_bc.py method=$method \
