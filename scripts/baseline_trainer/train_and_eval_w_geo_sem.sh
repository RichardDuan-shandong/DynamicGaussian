...
#       bash scripts/baseline_trainer/train_and_eval_w_geo_sem.sh ManiGaussian_BC 0,1 12345 ${exp_name}
# Other examples:
#       bash scripts/baseline_trainer/train_and_eval_w_geo_sem.sh GNFACTOR_BC 0,1 12345 ${exp_name}
